...
class Video_CallVC : UIViewController {
    ...
    var token = "007eJxTYLix6LvhY9Fsxd1Xvc2vrTx+Onrd/Tj11LU16nOsmhYG97xUYDC2sDA1MbM0NjOxTDZJMzVINDE2N09KTTVLSgMyEk1r1/knNwQyMixIlmdghEIQX5DBIzM3Ma84ozTeOSOxJN6xoICBAQB5OSUL"
    ...
    @IBAction func btnHideVideo(_ sender: UIButton) {
        ...
        if sender.isSelected {
            ...
            //            self.btnHideVideoOutlet.setImage(UIImage(named: "Hide_Video"), for: .normal)
        }
        else{
            self.selfVideoView.alpha = 1.0
            //            self.btnHideVideoOutlet.setImage(UIImage(named: "Show_Video"), for: .normal)
        }
    }
}
